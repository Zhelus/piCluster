...
banner=$(awk '/#beginBANNERconfig/{flag=1; next} /#endBANNERconfig/{flag=0} flag' /etc/opt/piLab/masterConfig)
prompt=$(awk '/#beginPROMPTconfig/{flag=1; next} /#endPROMPTconfig/{flag=0} flag' /etc/opt/piLab/masterConfig)
